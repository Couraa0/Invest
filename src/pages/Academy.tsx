  ...
  return (
    <div className="border border-slate-100 rounded-xl overflow-hidden bg-white hover:border-slate-200 hover:shadow-sm transition-all">
      ...
      >
        {/* Thumbnail */}
        <div
          className="relative shrink-0 w-24 h-14 rounded-lg overflow-hidden bg-slate-100 group cursor-pointer"
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm font-semibold text-primary truncate">{curriculum.title}</p>
          <div className="flex items-center gap-1.5 mt-0.5">
            <Clock className="w-3 h-3 text-on-surface-variant/40" />
            <span className="text-[10px] text-on-surface-variant/50 font-medium">{curriculum.duration}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            onClick={e => { e.stopPropagation(); onPlay(curriculum); }}
            className="p-2 bg-primary/8 text-primary rounded-lg hover:bg-primary/15 transition-colors"
            title="Tonton video"
          >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span className={cn('text-[10px] font-bold uppercase tracking-wider', module.color)}>
              {module.title}
            </span>
            <span className="px-2 py-0.5 bg-slate-100 text-on-surface-variant/50 rounded-md text-[9px] font-bold">
              {module.curricula.length} Kurikulum
            </span>
            <span className="px-2 py-0.5 bg-slate-100 text-on-surface-variant/50 rounded-md text-[9px] font-bold flex items-center gap-1">
        ...
        >
          ...
          <div className="flex gap-3">
            {[
              ...
              <div key={i} className="card px-3 py-2.5 rounded-xl text-center min-w-[72px]">
                ...
                <p className="text-[9px] text-on-surface-variant/50 font-medium">{stat.label}</p>
              </div>
            ))}
          </div>
        </motion.div>
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mt-3">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-white/70">Cocok untuk investor pemula</span>
                </div>
                <div className="flex items-center gap-1.5">
