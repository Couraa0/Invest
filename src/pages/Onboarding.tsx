    ...
    <div className="min-h-screen bg-surface flex flex-col justify-center items-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-primary mb-3 tracking-tight">Kustomisasi AI Anda</h1>
          <p className="text-base text-on-surface-variant/60 max-w-md mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          {levels.map((level, i) => (
            <motion.button
              ...
              className={cn(
                "p-6 rounded-3xl text-left transition-all duration-300 relative overflow-hidden group",
        ...
        <div className="flex justify-center">
          <button
            ...
            className="btn-primary w-full max-w-xs flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100"
          >
