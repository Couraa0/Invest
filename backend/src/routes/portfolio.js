...
const { getPortfolio, buyStock, sellStock, getTransactions, resetPortfolio } = require('../controllers/portfolioController');
...
router.delete('/:userId/reset', resetPortfolio);
...
router.delete('/reset', (req, res, next) => { req.params.userId = req.userId; resetPortfolio(req, res, next); });
